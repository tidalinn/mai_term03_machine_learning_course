# ML System Design Doc - MVP Системы определения кухни по названию блюда с рекомендацией ресторанов
...
1.1 Признаки | `name`
1.2 | Кодирование признаков | 1) ML - TfidfVectorizer<br>2) DL - tf.keras.layers.TextVectorization
1.3 | Целевой признак | `primary_cuisine`
1.4 | Кодирование целевого признака | MultiLabelBinarizer
1.5 | Метрики | `accuracy`
1.6 | Функция потерь | `binary_crossentropy`
1.7 | Порог | 0.6
1.8 | Baseline ML | OneVsRestClassifier + LogisticRegression
1.9 | DL модель | FCNN
